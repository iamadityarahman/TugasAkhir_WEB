...
<div class="w3-row w3-margin-top">
    <div class="w3-col l8 m12 s12">
        <div class="w3-container">
            <!-- memberi nama -->
            <div class='w3-bar w3-green w3-padding'>
            ...
            <!-- rating -->
            <div class='w3-bar w3-green w3-padding w3-margin-top'>
    ...
    <div class="w3-col l4 m12 s12 w3-margin-bottom">
        <div class="w3-container">
            <div class="w3-bar w3-black w3-col w3-margin-bottom w3-padding">
            ...
            <div class="w3-display-container w3-margin-bottom">
                ...
                <div class="w3-display-bottomright">
                    <button type="button" class="w3-button w3-green w3-xlarge"  onClick="alert('No telpon: <?=$z['phone']?>')">
                        <i class="fa fa-phone" aria-hidden="true"></i>
                    </button>
                    <button type="button" class="w3-button w3-green w3-xlarge" onClick="location.href='mailto:<?=$z['email']?>'">
        ...
        <div class="w3-container">
            <?php
                ...
                while ($iii = mysql_fetch_array($sqlpp)) { $xyz++; $fgh = "id" . $xyz;
                    if($iii['jenis'] == "360") { ?>
                        <div onclick="document.getElementById('<?=$fgh?>').style.display='block'" class="w3-half w3-display-container w3-border">
                            ...
                            <div class="w3-display-middle w3-xxlarge w3-white w3-padding-small w3-circle w3-opacity">360&deg;</div>
                        </div>
